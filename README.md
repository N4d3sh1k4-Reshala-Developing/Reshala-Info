...
**Reshala** — это отказоустойчивая распределенная система и нативное Android-приложение для автоматического распознавания математических выражений по фотографиям и генерации их пошаговых решений. 
